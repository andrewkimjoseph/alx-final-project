    ...
    if (double.tryParse(loanAmountGiven.text) == null ||
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (_) {
        return displayScreen(
            theWorkingList, loanAmountGiven.text, loanPeriodYearsGiven.text);
      }));
    }
  }

  Widget displayScreen(List<List<dynamic>> data, amount, years) {
    var commaFormat = NumberFormat("###,###,###", "en_US");
    ...
    return Scaffold(
      ...
      body: Builder(
        builder: (context) {
          // print(snapshot.data!);
          int maxLoanYears = int.parse(data
              .toList()[5][1]
              .replaceAll(' YEARS', '')
              .replaceAll(' YEAR', '')
              .toString());
          // print(maxLoanYears);
          int totalPayableAmount = int.parse(data
              .toList()[1][1]
              .toString()
              .replaceAll('KES. ', '')
              .replaceAll(',', ''));
          ...
          int totalPayablePrincipal = int.parse(data
              .toList()[0][1]
              .toString()
              .replaceAll('KES. ', '')
              .replaceAll(',', ''));
          ...
          int totalPayableInterest = int.parse(data
              .toList()[2][1]
              .toString()
              .replaceAll('KES. ', '')
              .replaceAll(',', ''));
